  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.myPhotoDescription, "<br/>").concat(photomarker.original_date_time)
        }
      });
...
/******/ });
//# sourceMappingURL=application-e8c53ffca3d661d86945.js.map