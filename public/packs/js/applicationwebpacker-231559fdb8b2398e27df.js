  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<h3><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></h3><br/>\n        ").concat(photomarker.myPhotoDescription, "<br/>\n        ").concat(photomarker.original_date_time, "<br/>\n        ").concat(photomarker.address, "<br/>\n        ").concat("photomarker id: " + photomarker.id, "<br/>\n        <h3><a href='").concat(photomarker.get_image_link, "'>").concat(photomarker.myPhotoTitle, "</a></h3><br/>\n\n\n        <img src='").concat(photomarker.get_image_link, "' style=\"width:150px; height:auto;\"><br/>\n\n        ").concat(photomarker.myPhotoAperture, "<br/>")
        }
      });
...
/******/ });
//# sourceMappingURL=applicationwebpacker-231559fdb8b2398e27df.js.map