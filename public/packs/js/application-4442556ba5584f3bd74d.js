  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.original_date_time, "<br/>").concat(photomarker.myPhotograph.id)
        }
      });
...
/******/ });
//# sourceMappingURL=application-4442556ba5584f3bd74d.js.map