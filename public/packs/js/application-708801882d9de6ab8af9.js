  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.myPhotoDescription, "<br/>").concat(photomarker.original_date_time, "<br/>").concat(photomarker.address)
        }
      });
...
/******/ });
//# sourceMappingURL=application-708801882d9de6ab8af9.js.map