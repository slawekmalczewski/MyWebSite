  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.myPhotograph, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.original_date_time)
        }
      });
    }
  });
...
/******/ });
//# sourceMappingURL=application-fdd0114e5ea7fe7a43cb.js.map