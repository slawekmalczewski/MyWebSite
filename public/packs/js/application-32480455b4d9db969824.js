  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.MyPhoto.myPhotograph, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.original_date_time)
        }
      });
    }
  });
...
/******/ });
//# sourceMappingURL=application-32480455b4d9db969824.js.map