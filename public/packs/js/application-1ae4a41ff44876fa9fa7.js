  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.original_date_time, "<br/>").concat(photomarker.my_photos)
        }
      });
...
/******/ });
//# sourceMappingURL=application-1ae4a41ff44876fa9fa7.js.map