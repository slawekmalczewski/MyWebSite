  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.original_date_time, "<br/>").concat(photomarker.geocode)
        }
      });
...
/******/ });
//# sourceMappingURL=application-efb028a4b61524d8f6bc.js.map