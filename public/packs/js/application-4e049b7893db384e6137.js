  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.original_date_time, "<br/>").concat(photomarker.photo_gallery_id)
        }
      });
...
/******/ });
//# sourceMappingURL=application-4e049b7893db384e6137.js.map