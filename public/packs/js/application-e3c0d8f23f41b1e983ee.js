...
__webpack_require__(/*! ./lightboxtest/lightbox.js */ "./app/javascript/packs/lightboxtest/lightbox.js");

/***/ }),

/***/ "./app/javascript/packs/lightboxtest/lightbox.js":
/*!*******************************************************!*\
  !*** ./app/javascript/packs/lightboxtest/lightbox.js ***!
  \*******************************************************/
/*! no static exports found */
...
console.log("Hello from LIGHTBOX")(function (root, factory) {
  if (true) {
  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.original_date_time)
        }
      });
    }
  });
...
/******/ });
//# sourceMappingURL=application-e3c0d8f23f41b1e983ee.js.map