  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<h3><a href='".concat(photomarker.get_image_link, "'>").concat(photomarker.myPhotoTitle, "</a></h3>\n        <img src='").concat(photomarker.get_image_link, "' style=\"width:150px; height:auto; border: 1px solid #ddd; padding: 5px; margin-bottom:8px; marginm-top: 15px;\"><br/>\n        <h5>").concat(photomarker.myPhotoDescription, "</h5><br/>\n        <p style=\"font-family: Arial, Sans-serif; font-size: 12px; color:blue; line-height:16px;\">\n        ").concat("Aperture: " + photomarker.myPhotoAperture, "<br/>\n        ").concat("Shutter Speed: " + photomarker.myPhotoShutterSpeed, "<br/>\n        ").concat("ISO: " + photomarker.myPhotoISO, "<br/>\n        ").concat(photomarker.original_date_time, "<br/></p>")
        }
      });
...
/******/ });
//# sourceMappingURL=applicationwebpacker-821a3a581add0754d92f.js.map