  ...
  photomarkers.forEach(function (photomarker) {
    if (photomarker.latitude && photomarker.longitude) {
      var marker = map.addMarker({
        ...
        infoWindow: {
          content: "<p><a href='/photomarkers/".concat(photomarker.id, "'>").concat(photomarker.myPhotoTitle, "</a></p><br/>").concat(photomarker.myPhotoDescription, "<br/>").concat(photomarker.original_date_time, "<br/>").concat(photomarker.reverse_geocode)
        }
      });
...
/******/ });
//# sourceMappingURL=application-dcdb3e1a0c106aec9f72.js.map